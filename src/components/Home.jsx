  ...
  return (
    <div name='home' className='relative z-40 w-full h-screen bg-[#1F2839]'>
        ...
        <div className='lg:hidden flex justify-center items-center absolute bottom-24 w-full space-x-4'>
            ...
            <a className='text-gray-300 hover:text-[#FF572A] text-center' href="https://drive.google.com/file/d/1cx9EZhtjTRALGyNLxsBupJ0e-oplj-J7/view?usp=drive_link" target="_blank" rel="noopener noreferrer">
