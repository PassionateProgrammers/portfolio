    ...
    <div name='work' className='w-full md:h-screen text-gray-300 bg-[#1F2839]'>
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
            ...
            <div className='grid sm:grid-cols-2 gap-8'>
                <div style={{backgroundImage: `url(${ap76logo})`}} className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'>
                    {/* Hover Effects */}
                    <div className='opacity-0 group-hover:opacity-100 flex flex-col justify-center items-center'>
                        <span className='text 2xl font-bold text-white tracking-wider'>
                            ap76
                        ...
                        <div className='pt-8 text-center'>
                            <a href="https://passionateprogrammers.github.io/ap76/#/" target="_blank" rel="noopener noreferrer">
                                <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg'>Demo</button>
                            </a>
                            <a href="https://github.com/PassionateProgrammers/ap76" target="_blank" rel="noopener noreferrer">
                ...
                <div>
                    <h2 className='text-2xl font-bold mb-4 text-gray-300'>ap76</h2>
                    <p className='text-gray-300'>
                    A web application for a Non-Profit Organization built with React, Javascript, html, tailwindCSS, and custom CSS. Form made using Getform API. Stripe used as payment gateway for donations.
                    </p>
                    <div className="flex items-center mt-4">
                        <p className="text-gray-300 mr-4">Technologies used:</p>
                        <span className="mr-1" title="HTML">
